...
const translations = {
  en: {
    ...
    khataFeature: "Khata / Udhar Book",
    khataFeatureDesc: "Track customer credit & payments. Know who owes what, instantly.",
    inventoryFeature: "Stock Management",
    inventoryFeatureDesc: "Track items, quantities & get low stock alerts automatically.",
    invoiceFeature: "Invoice / Bill Generator",
    invoiceFeatureDesc: "Create GST invoices & share via PDF or WhatsApp in seconds.",
    expenseFeature: "Income & Expense Tracker",
    expenseFeatureDesc: "Record daily income & expenses. See your profit/loss at a glance.",
    advanceFeature: "Worker Advance Tracker",
    advanceFeatureDesc: "Track salary advances & loans given to workers with one tap.",
  ...
  hi: {
    ...
    // Khata Book
    khataBook: "खाता बुक",
    khataSubtext: "ग्राहकों को दिए गए उधार को ट्रैक करें",
    addEntry: "एंट्री जोड़ें",
    khataCredit: "उधार दिया",
    khataDebit: "पैसे मिले",
    khataBalance: "शेष राशि",
    khataDescPlaceholder: "जैसे किराने का सामान खरीदा",
    noKhataEntries: "अभी तक कोई खाता एंट्री नहीं",
    khataDeleteConfirm: "क्या आप वाकई इस एंट्री को हटाना चाहते हैं?",
    amount: "राशि",
    description: "विवरण",
    date: "तारीख",
    ...
    // Inventory
    inventory: "इन्वेंटरी",
    inventorySubtext: "अपने स्टॉक को ट्रैक करें और कम स्टॉक अलर्ट पाएं",
    addItem: "आइटम जोड़ें",
    editItem: "आइटम संपादित करें",
    itemName: "आइटम का नाम",
    itemNamePlaceholder: "जैसे चावल, साबुन, तेल",
    quantity: "मात्रा",
    unit: "इकाई",
    ...
    noInventoryItems: "अभी तक कोई इन्वेंटरी आइटम नहीं",
    inventoryAdded: "आइटम जोड़ा गया!",
    inventoryUpdated: "आइटम अपडेट किया गया!",
    inventoryDeleteConfirm: "क्या आप वाकई इस आइटम को हटाना चाहते हैं?",

    // Invoices
    invoices: "बिल / इनवॉइस",
    invoicesSubtext: "GST बिल बनाएं और शेयर करें",
    createInvoice: "बिल बनाएं",
    invoiceItems: "आइटम",
    invoiceTo: "बिल के लिए",
    invoiceFrom: "बिल प्रेषक",
    invoiceCreated: "बिल बनाया गया!",
    noInvoices: "अभी तक कोई बिल नहीं",

    // Expense Tracker
    expenseTracker: "आय-व्यय ट्रैकर",
    expenseSubtext: "दैनिक आय और खर्चे ट्रैक करें, लाभ/हानि देखें",
    income: "आय",
    expense: "खर्च",
    profitLoss: "लाभ / हानि",
    incomeAdded: "आय दर्ज की गई!",
    expenseAdded: "खर्च दर्ज किया गया!",
    noExpenses: "इस महीने कोई एंट्री नहीं",
    expenseDescPlaceholder: "जैसे थोक विक्रेता से सामान खरीदा",
    expenseDeleteConfirm: "क्या आप वाकई इस एंट्री को हटाना चाहते हैं?",

    // Worker Advances
    workerAdvances: "कर्मचारी एडवांस",
    advancesSubtext: "कर्मचारियों को दिए गए एडवांस और लोन ट्रैक करें",
    addAdvance: "एडवांस जोड़ें",
    selectWorker: "कर्मचारी चुनें",
    advanceDescPlaceholder: "जैसे त्योहार एडवांस",
    advanceAdded: "एडवांस दर्ज किया गया!",
    pendingAdvances: "बाकी",
    deductedAdvances: "काटा गया",
    pending: "बाकी",
    deducted: "काटा गया",
    noAdvances: "अभी तक कोई एडवांस दर्ज नहीं",
    advanceDeleteConfirm: "क्या आप वाकई इस एडवांस को हटाना चाहते हैं?",
    ...
    khataFeature: "खाता / उधार बुक",
    khataFeatureDesc: "ग्राहकों का उधार और भुगतान ट्रैक करें। तुरंत जानें किसका कितना बाकी है।",
    inventoryFeature: "स्टॉक प्रबंधन",
    inventoryFeatureDesc: "आइटम, मात्रा ट्रैक करें और कम स्टॉक अलर्ट स्वचालित रूप से पाएं।",
    invoiceFeature: "बिल / इनवॉइस जनरेटर",
    invoiceFeatureDesc: "GST बिल बनाएं और सेकंडों में PDF या WhatsApp से शेयर करें।",
    expenseFeature: "आय-व्यय ट्रैकर",
    expenseFeatureDesc: "दैनिक आय और खर्चे दर्ज करें। एक नज़र में लाभ/हानि देखें।",
    advanceFeature: "कर्मचारी एडवांस ट्रैकर",
    advanceFeatureDesc: "कर्मचारियों को दिए गए एडवांस और लोन को एक टैप से ट्रैक करें।",
